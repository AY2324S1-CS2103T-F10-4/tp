...
1. As a tutor, I want to be able to view a list of all tutees.
2. As a tutor, I want to be able to view the specific details of a single tutee.
3. As a tutor, I want to be able to add a new tutee.
4. As a tutor, I want to be able to edit their details, so that I can account for changes in their information e.g change in address
5. As a tutor, I want to be able to remove tutees from the list, so that I can stop keeping track of tutees that I have stopped teaching
